...
Isadmin=$(curl -sS https://raw.githubusercontent.com/FadlyNotNot/prem/main/izin | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/FadlyNotNot/prem/main/izin | grep $MYIP | awk '{print $3}')
fi
